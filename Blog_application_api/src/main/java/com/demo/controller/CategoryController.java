...
public class CategoryController {
	...
	public ResponseEntity<CategoryDto> createCategory(@Valid @RequestBody CategoryDto categoryDto){
		CategoryDto createCategory = this.categoryService.createCaegory(categoryDto);
	...
	public ResponseEntity<ApiResponse> deleteCategory(@PathVariable Integer catId){
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse("category os deleted usccessfully !!", false),HttpStatus.OK);
	}
	//get
	@GetMapping("/{catId}")
	public ResponseEntity<CategoryDto> getCategory(@RequestBody CategoryDto categoryDto,@PathVariable Integer catId){
		CategoryDto createCategory = this.categoryService.getCategoryById(catId);
		return new ResponseEntity<CategoryDto>(createCategory, HttpStatus.OK);
	}
	//get all
	@GetMapping("/")
	public ResponseEntity<List<CategoryDto>> getAllCategories(){
		List<CategoryDto> getCategories = this.categoryService.getAllCategories();
